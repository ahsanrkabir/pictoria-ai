...
const formSchema = z.object({
  ...
  num_outputs: z.number().min(1, { message: "Number of outputs must be at least 1" }).max(4, { message: "Number of outputs must be less than or equal to 4" }),
  ...
  output_quality: z.number().min(1, { message: "Output quality must be at least 1" }).max(100, { message: "Output quality must be less than or equal to 100" }),
  num_inference_steps: z.number().min(1, { message: "Number of inference steps must be at least 1" }).max(50, { message: "Number of inference steps must be less than or equal to 50" }),
})
